...
namespace GlobalDemo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var query = "SELECT TOP 1 * FROM c WHERE c.vin = 16016";
            ...
            while (true)
            {
                ...
                var document = client.CreateDocumentQuery<dynamic>(UriFactory.CreateDocumentCollectionUri("Demo", "VehicleData"), query, feedOptions ).ToList().FirstOrDefault();
